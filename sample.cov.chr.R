...
setwd("/share/Data01/tianwei/FASTQC/TEMP/MCGI_Zebra01_CL100082121/3_Alignment/MSOB_16_033_BC_WES")

parsed_xml_file <- "MSOB_16_033_BC_WES.cov.chr.xml"
...
ggexport(multi.page, filename = "MSOB_16_033_BC_WES.qprofile.ggplot2.pdf")
